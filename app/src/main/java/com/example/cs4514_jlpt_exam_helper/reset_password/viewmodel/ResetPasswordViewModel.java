package com.example.cs4514_jlpt_exam_helper.reset_password.viewmodel;
...
public class ResetPasswordViewModel extends ViewModel {
    ...
    public void setResetPasswordSuccess(MutableLiveData<Boolean> resetPasswordSuccess) {
    ...
    public void getResetPasswordOtp(String email){
        ...
        Single<ResponseBean<Account>> response = otpRepository.getResetPasswordOtp(new Account(email));
    ...
    public void resetPassword(String password, String confirmPassword){
        ...
        String email = emailForVerify.getValue();
        Single<ResponseBean<String>> response = accountRepository.resetPassword(new Account(email, password));
    ...
    public boolean validPassword(String password, String confirmPassword){
        ...
        boolean result = validPassword.getValue().isValid() && validConfirmPassword.getValue();
